  ...
  const moduleContent = () => {
    switch (selectedModule) {
      ...
      default:
        ...
        <p>
            Welcome to the Beach Safety Module, your comprehensive guide to staying safe and informed while enjoying the coastal beauty.In this module, you'll dive deep into the essential aspects of beach safety, covering everything from flag signs to scenario-based learning. Our goal is to empower you with the knowledge and skills needed to navigate the beach environment confidently.Throughout this module, you'll explore:</p>
        <ol>
